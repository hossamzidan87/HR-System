                ...
                <tbody>
                    ...
                    $employees_sql = "SELECT e.*, 
                                      ...
                                      WHERE e.department = '$selected_department' 
                                        AND (o.overtime_date IS NULL OR e.employee_code NOT IN (SELECT employee_code FROM overtime WHERE overtime_date = '$selected_date'))
                    ...
                    if ($employees_result->num_rows > 0) {
                        while ($row = $employees_result->fetch_assoc()) {
                            ...
                            $remaining_hours = (12 - $total_hours);
...
$submitted_employees_sql = "SELECT t.employee_code, t.employee_name, t.bus_line_name, t.department, t.job, t.types,
