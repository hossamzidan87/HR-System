...
if ($stmt) {
    ...
    if ($result->num_rows > 0) {
        ...
        if ($current_time < $shift_start || $current_time > $shift_end) {
            echo "<H3>This page can only be accessed between $shift_start and $shift_end.</H3>";
                  echo "<a href='shifts_home.php'><img width='50' height='50' src='/images/icons/home.png' alt='home'></a>";
            exit;
        }
    } else {
